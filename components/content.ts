...
export const INSTRUCTORS = [
  {
    ...
    bio: "Implementira AI u svakodnevne poslove tvrtki: od automatizacija do kompletne AI arhitekture.",
    tag: "AI implementacija",
  ...
  },
  {
    id: "ivan-radica",
    name: "Ivan Radica",
    role: "Osnivač SEO Lick (10+ god.)",
    bio: "Više od desetljeća u SEO-u. Vodi kako AI koristiti za SEO, AEO i GEO vidljivost koja donosi rezultate.",
    tag: "SEO · AEO · GEO",
